...
public partial class AdminWindowViewModel : ViewModelBase
{
    ...
    partial void OnSelectedListItemChanged(ListItemTemplate? value)
    {
        ...
        {
            // 🚀 This ensures the submenu item is **instantly highlighted**!
            if (SelectedListItem != value)
            {
                SelectedListItem = null; // Reset selection first (forces UI update)
                SelectedListItem = value; // Then set the correct selection
            }
